...
<body>
    ...
    <!-- Radio button grupa za odabir tipa HTTP zahteva koji želimo da pošaljemo -->
        ...
        <pre id="get_odgovor" style="display: none;"></pre>

        <!-- Div sekcija za POST formu za novosti -->

        <div id="novosti_post" style="display: none;">
        ...
        <div id="kategorije_post" style="display: none;">
        ...
        <div id="brisanje_reda" style="display: none;">
        ...
        <div id="kategorije_put" style="display: none;">
        ...
        <div id="novosti_put" style="display: none;">
        ...
        <div id="greska" style="display: none;">
            ...
            switch ( $("input[name=http_zahtev]:checked")[0].id){
                ...
                //proveravamo koja je tabela
                    if(tabela=="radio_novosti"){
                        ...
                        $.getJSON("http://localhost:8080/rest/rest/novosti", function(data){
                        ...
                        $.getJSON("http://localhost:8080/rest/rest/kategorije", function(data){
                            document.getElementById("get_odgovor").innerHTML = JSON.stringify(data,null,2);
                        });
                    }
                    break;
                ...
                // prikupimo podatke koje hoćemo da pošaljemo iz forme
                        ...
                        $.post("http://localhost:8080/rest/rest/novosti", JSON.stringify(values),function(data){
                        ...
                        console.log(values);
                        $.post("http://localhost:8080/rest/rest/kategorije", JSON.stringify(values),function(data){
                            alert("Odgovor od servera> "+data['poruka']);
                        });
